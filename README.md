<div align="center">
  <img src="https://github.com/user-attachments/assets/882fcc25-4459-4881-9c44-8f17c20cb251">
  <h1>DefeatFit</h1>
</div>
...
本アプリは対戦での「負け」というネガティブな経験を、「筋トレによる健康維持・自身の成長」というポジティブな経験に置き換えることが目的で生まれました。
...
4. `npm run build`でビルド
  - `defeat-fit/dist/release/`にビルド済みアプリが出力されます
